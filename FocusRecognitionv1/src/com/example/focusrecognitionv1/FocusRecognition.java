...
public class FocusRecognition extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_focus_recognition);
	...
	Camera.PictureCallback mCall = new Camera.PictureCallback() {  
		public void onPictureTaken(byte[] data, Camera camera) {  
			...
			Message.obtain(threadHandler, FocusRecognition.NEXT, "").sendToTarget();   
...
//		getMenuInflater().inflate(R.menu.focus_recognition, menu);
//		return true;
//	}
//
//	@Override
